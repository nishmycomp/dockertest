...
# Deploy tenant configuration fix to PDF service
# This script updates the PDF service to include the app_3_my_companionship tenant

echo "🚀 Deploying tenant configuration fix to PDF service..."
...
echo "✅ Tenant configuration fix deployed successfully!"
echo ""
echo "📋 What was updated:"
echo "  • Added app_3_my_companionship tenant to PDF service configuration"
echo "  • Updated Laravel URL mapping for the new tenant"
echo "  • PDF service now supports the correct tenant database"
echo ""
